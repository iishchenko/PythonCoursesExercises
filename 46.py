...
def debug(number, count):  
  print(number, count)
  print("num ", number, ": num != 1 (", number != 1, ") OR num != 2(", number != 2, ") =", number != 1 or number != 2)
  print("num ", number, ": num != 1 (", number != 1, ") AND num != 2(", number != 2, ") =", number != 1 and number != 2)
  print("num ", number, ": num == 1 (", number == 1, "), num == 2(", number == 2, "). not (num == 1 or num == 2)", number == 1 or number == 2, ". not (num == 1 or num == 2)", not (number == 1 or number == 2))
  input()
